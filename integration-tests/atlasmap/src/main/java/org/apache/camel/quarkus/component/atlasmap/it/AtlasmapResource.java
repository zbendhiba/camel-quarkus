...
public class AtlasmapResource {
    ...
    private static final Logger LOG = Logger.getLogger(AtlasmapResource.class);
    ...
    @GET
    @Path("adm/json2xml")
    public String convertJsonToXmlWithAdm(String xml) {
